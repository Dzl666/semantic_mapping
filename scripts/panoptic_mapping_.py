...
def parse_args():
    ...
    parse.add_argument("--use_temporal_results", action='store_true', 
        help="use 2D segments results ")
    parse.add_argument("--temporal_results", action='store_true', 
        help="save intermediate 2D segments results ")
    parse.add_argument("--temporal_results_img", action='store_true', 
    ...
    parse.add_argument("--use_temporal_panoptics", action='store_true', 
        help="use 2D panoptic segments ")
    parse.add_argument("--temporal_panoptics", action='store_true', 
        help="save 2D panoptic segments ")
    parse.add_argument("--temporal_panoptics_folder", type=str, default='segments', 
        help="folder to save 2D panoptic segments ")

    parse.add_argument("--use_temporal_geometrics", action='store_true', 
        help="use 2D geometrics segments ")
    parse.add_argument("--temporal_geometrics", action='store_true', 
        help="save 2D geometrics segments ")
    parse.add_argument("--temporal_geometrics_folder", type=str, default='segments', 
