...
import pickle
cate_id_info= None
cate_id_info_f = "./scripts/semantics/cate_id_info.pkl"
...
pano_seg_class = \
  {"Person": [0], "Bench": [13], "bag": [24], "Bottle": [39], "Cup": [41], "chair": [56], "sofa": [57], "bed": [59], "table": [60,122], "Toilet": [61], 
   "television": [62], "Laptop": [63], "Mouse": [64], "Keyboard": [66], "Microwave": [68], "Oven": [69], "fridge": [72], "Book": [73], "Cabinet": [121], 
...
CLASS_LABELS_GT = [class_name for class_name in pano_seg_class]
...
VALID_CLASSLABEL2ID = {}
for class_label in pano_seg_class:
    VALID_CLASSLABEL2ID[class_label] = pano_seg_class[class_label][0]

VALID_ID2CLASSLABEL = {}
for class_label in pano_seg_class:
    VALID_ID2CLASSLABEL[pano_seg_class[class_label][0]] = class_label
